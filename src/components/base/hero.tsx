  ...
  return (
    <div>
      <div className="relative isolate">
        <svg
          aria-hidden="true"
          className="absolute inset-x-0 top-0 -z-10 h-[64rem] w-full stroke-gray-200 [mask-image:radial-gradient(32rem_32rem_at_center,white,transparent)] dark:stroke-gray-700"
        >
          <defs>
            <pattern
              x="50%"
          ...
          <svg
            x="50%"
            y={-1}
            className="overflow-visible fill-gray-50 dark:fill-slate-700"
          >
            <path
              d="M-200 0h201v201h-201Z M600 0h201v201h-201Z M-400 600h201v201h-201Z M200 800h201v201h-201Z"
              strokeWidth={0}
        ...
        >
          <div
            ...
            className="aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr from-[#80caff] to-[#4f46e5] opacity-30"
          />
        </div>
            ...
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                <h1 className="text-pretty text-5xl font-semibold tracking-tight text-foreground sm:text-7xl">
                  Dein Überblick für Bestellungen und Verkäufe
                </h1>
                <p className="mt-8 text-pretty text-lg font-medium text-foreground/70 sm:max-w-md sm:text-xl/8 lg:max-w-none">
                  Mach Schluss mit dem Chaos. Organisiere Deine Bestellungen und
                  Verkäufe an einem zentralen Ort. Analysiere, optimiere und
                  verfolge alles, was für Dich wichtig ist. Klar, effizient und
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  ...
                  <Link
                    href="/features"
                    className="text-sm/6 font-semibold text-foreground hover:text-foreground/80"
                  >
                    Mehr erfahren <span aria-hidden="true">→</span>
                  </Link>
                </div>
